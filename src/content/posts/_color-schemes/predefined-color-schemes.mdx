...
To apply a predefined color scheme, copy the CSS variable definitions into your theme configuration. For detailed setup instructions, see the [color scheme configuration guide](/astro-paper/posts/customizing-astropaper-theme-color-schemes/).
